...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // FLuttercoin is not connected
...
extern json_spirit::Value fluttershare(const json_spirit::Array& params, bool fHelp);// Credit Tranz5 (HBN and CAP)
